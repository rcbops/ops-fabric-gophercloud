...
func (r HypervisorPage) NextPageURL() (string, error) {
	...
	err := r.ExtractInto(&s)
	if err != nil {
		fmt.Fprintln(os.Stdout, "No next link found")
		return "", err
	}
	fmt.Fprintln(os.Stdout, "Extracting next URL...")
...
func ExtractHypervisors(p pagination.Page) ([]Hypervisor, error) {
	...
	fmt.Fprintln(os.Stdout, "Extracting a page of hypervisors...")
...
func (r HypervisorResult) Extract() (*Hypervisor, error) {
	...
	fmt.Fprintln(os.Stdout, "Extracting HypervisorResult into a Hypervisor")
	err := r.ExtractInto(&s)
...
func (r StatisticsResult) Extract() (*Statistics, error) {
	...
	fmt.Fprintln(os.Stdout, "Extracting a statistic result")
	err := r.ExtractInto(&s)
	return &s.Stats, err
}
...
func (r UptimeResult) Extract() (*Uptime, error) {
	...
	fmt.Fprintln(os.Stdout, "Extracting an UptimeResult")
	err := r.ExtractInto(&s)
	return &s.Uptime, err
}
